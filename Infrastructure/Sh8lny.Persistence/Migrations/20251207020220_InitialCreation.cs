    ...
    public partial class InitialCreation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedOpportunities", x => x.SavedID);
                    table.ForeignKey(
                        name: "FK_SavedOpportunities_Projects_ProjectID",
                        column: x => x.ProjectID,
                        principalTable: "Projects",
                        principalColumn: "ProjectID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavedOpportunities_Students_StudentID",
                        column: x => x.StudentID,
                        principalTable: "Students",
                        principalColumn: "StudentID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationModuleProgressId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ApplicationModuleProgressId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedOpportunities_ProjectID",
                table: "SavedOpportunities",
                column: "ProjectID");

            migrationBuilder.CreateIndex(
                name: "IX_SavedOpportunities_StudentID_ProjectID",
                table: "SavedOpportunities",
